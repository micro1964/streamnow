...
Lista de ejemplos
  ...
  2.7. Uso de pattern (patrón) para agrupar paquetes en base a su desarrollador.
...
ejecute la orden tar zxf aptitude-0.6.8.2.tar.gz para desempaquetar el código
fuente. Una vez que haya desempaquetado el código fuente, introduzca cd
aptitude-0.6.8.2 &amp;&amp; ./configure &amp;&amp; make para compilar aptitude.
Si tiene éxito, asegúrese de que es el usuario root (usando su, por ejemplo), y
después teclee make install para instalar aptitude en su equipo. Una vez que
haya instalado aptitude con éxito, ejecutar aptitude en una terminal debería
iniciar el programa.
...
en http://git-scm.com/) y ejecute la orden git clone git://git.debian.org/git/
...
para generar los ficheros necesarios para compilar aptitude, a continuación
ejecute make y make install.
...
aptitude (consulte Capítulo 2, Guía_de_referencia_de_aptitude para ello), pero
...
|_________________________________________|______________________________________________________________________________|
|Vistas → Nuevo navegador de categorías|Muestra la lista de paquetes, agrupados por categoría.                       |
|_________________________________________|______________________________________________________________________________|
...
información acerca de un paquete) crearán nuevas vistas automáticamente; también
puede crear una nueva vista usando Vistas → Nueva vista de paquetes o Vistas →
Nuevo navegador de categorías.
...
|                                                                 |                                                                                  |
|Reinstalar: pulse L                                              |Tenga en cuenta que la reinstalación no se guardará cuando salga de aptitude o  |
...
|________________________________|___________________________________________|______________________________________________________________________________|
  ...
  ?tag(etiqueta), ~Getiqueta
   ...
   ?true, ~T
      Este término empareja todo paquete. Por ejemplo “?installed?provides
      (?true)” muestra los paquetes instalados que cualquier otro provee.
   ...
   ?virtual, ~v
      ...
      paquete con tal nombre. Por ejemplo “?virtual!?provides(?true)” muestra
      paquetes que son virtuales y que ningún otro paquete provee: declarados
      como dependencia pero que no existen.
...
%n        Versión del programa            La longitud de “0.6.8.2”. No        Mostrar la versión de aptitude que está ejecutando, actualmente “0.6.8.2”.
...
estándar.
  ...
  hier
      ...
      Agrupar paquetes de acuerdo a un fichero de datos adicional que describe
...
|______________________|______________|_________________________________________________________________________________|
|Commit                |N             |En el editor de jerarquías, almacena la posición del paquete actual en la      |
...
|______________________|______________|_________________________________________________________________________________|
|SaveHier              |S             |Guardar la jerarquía actual en el editor de jerarquías.                        |
|______________________|______________|_________________________________________________________________________________|
...
Dispone de las siguientes acciones:
  ...
  safe-upgrade
      ...
      instalados se eliminarán a menos que no se utilizen (consulte la sección
      “Gestionar paquetes automáticamente instalados” en la guía de referencia
      de aptitude). Los paquetes no instalados se pueden instalar para resolver
  ...
  show
      Muestra información detallada relativa a uno o más paquetes, listados de
      acuerdo a la orden «search». Si el nombre de un paquete contiene un
      carácter de tilde (“~”) o un signo de interrogación (“?”), se tomará como
      un patrón de búsqueda y verá todos aquellos paquetes coincidentes
      (consulte la sección “Patrones de búsqueda” en el manual de referencia de
      aptitude).
...
estas órdenes las ignorarán.
  ...
  -d, --download-only
   ...
   -F formato, --display-format formato
      Define el formato que se utilizar para mostrar la salida de las órdenes
      search y versions. Por ejemplo, introducir “%p %V %v” como formato muestra
      el nombre de un paquete, seguido de la versión actualmente instalada, así
      como la versión disponible (para más información, consulte la sección
      “Personalizar la presentación de los paquetes”) en el manual de referencia
      de aptitude).
  ...
  --full-resolver
      ...
      aunque Aptitude::Always-Use-Safe-Resolver tenga valor de «true». La orden
      safe-upgrade nunca utiliza el solucionador completo, y no acepta la opción
      --full-resolver.
