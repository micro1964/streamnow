...
package	Objects	Namespace	Modules	declare a separate global namespace
...
use	Objects	Namespace	Modules	load in a module at compile time and import its namespace
